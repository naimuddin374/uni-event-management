        ...
        <nav class="custom_tabs text-center">
          <div class="nav" id="nav-tab" role="tablist">
            ...
            <a class="nav-item nav-link" id="nav-contact-tab" data-toggle="tab"
              ...
              aria-selected="false">PHD Scholarships</a>
            <a class="nav-item nav-link" id="nav-contact-tab" data-toggle="tab"
          ...
          <div class="coures_info">
            <div class="section_title white_text">
              ...
              <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed
                ...
                aliqua. Ut enim ad minim <br> veniam, quis nostrud exercitation.
              </p>
            </div>
            <div class="coures_wrap d-flex">
              <div class="single_wrap">
                ...
                <h4>Bachelor of <br>
                  Graphic Design</h4>
                <p>Lorem ipsum dolor sit amet, sectetur adipiscing elit, sed do
                  eiusmod tpor incididunt ut piscing vcs.</p>
                <a href="#" class="boxed-btn5">Apply NOw</a>
              </div>
              <div class="single_wrap">
                <div class="icon">
          ...
          <div class="admission_form">
            ...
            <form action="#">
              <div class="row">
                ...
                <div class="col-md-12">
                  <div class="single_input">
                    <textarea cols="30" placeholder="Write an Application"
                      rows="10"></textarea>
                  </div>
                </div>
                <div class="col-md-12">
        ...
        <div class="single__news">
          ...
          <div class="news_info">
            ...
            <p class="d-flex align-items-center"> <span><i
                  class="flaticon-calendar-1"></i> May 10, 2020</span>
